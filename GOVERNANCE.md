...
`cloud-itonami-isco-8211` is an OSS open-occupation blueprint. Governance covers
...
- Mechanical Assembly Line Scheduling Coordination Governor remains independent of the advisor.
- hard policy violations cannot be overridden by human approval.
- an assembly-execution decision, a line-safety-clearance decision, and any
  override of a plant safety officer's judgment, stay permanently outside
...
- attempting to route an assembly-execution decision, a line-safety-
  clearance decision, or a plant-safety-officer-override decision, through
  this actor
